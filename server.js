...
// --- API ROUTES ---
app.post('/api/shortcut', async (req, res) => { /* ... unchanged ... */ });
const superAdminApi = require('./api/superAdmin');
app.use('/api/super', superAdminApi(bot));
app.get('/api/internal/cron', async (req, res) => { /* ... unchanged ... */ });

// --- PAYMENT & CRON LOGIC ---
async function processPayment(amount, bot, method = "Unknown") { /* ... unchanged ... */ }
...
bot.on('callback_query', async (callbackQuery) => {
    ...
    if (data.startsWith('sub_report_')) {
        // ... (report callback logic is unchanged)
    }
...
// ... (rest of the file, full code below)
// Full, correct, copy-pasteable server.js
